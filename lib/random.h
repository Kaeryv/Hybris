...
u32
pcg32_random(struct pcg32_random *prng);

subroutine
pcg32_random_seed(struct pcg32_random *prng, u64 s1);

u32
pcg32_random_sample(struct pcg32_random *prng, f64 *distribution, u32 len);
